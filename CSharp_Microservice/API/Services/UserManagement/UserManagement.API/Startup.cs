...
namespace UserManagement.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Grpc Configuration
            services.AddGrpcClient<CompetencyFrameworkProtoService.CompetencyFrameworkProtoServiceClient>
                        (o => o.Address = new Uri(Configuration["GrpcSettings:RoleUrl"]));
            services.AddScoped<CompetencyFrameworkGrpcService>();
            services.AddGrpcClient<SurveyManagementProtoService.SurveyManagementProtoServiceClient>
                        (o => o.Address = new Uri(Configuration["GrpcSettings:SurveyUrl"]));
            services.AddScoped<SurveyListGrpcService>();

            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo { Title = "UserManagement.API", Version = "v1" });
            });

            services.AddHealthChecks()
                    .AddDbContextCheck<UserManagementContext>();
            ...
            services.AddCors(o => o.AddPolicy("UserManagementCorsPolicy", builder =>
            {
